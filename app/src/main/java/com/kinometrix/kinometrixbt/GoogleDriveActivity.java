...
public class GoogleDriveActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,  EasyPermissions.PermissionCallbacks{
    ...
    private final String KINOMETRIX_DIRECTORY_GOOGLEDRIVE_NAME = "UserData";

    private final String LOG_TAG = GoogleDriveActivity.class.getSimpleName();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setItems(new CharSequence[]{"Send file to Google Drive"},
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, Void> {
        ...
        MakeRequestTask(GoogleAccountCredential credential) {
            ...
            mService = new com.google.api.services.drive.Drive.Builder(
                    ...
                    .setApplicationName("Kinometrix logs")
                    .build();
        }
        ...
        private void sendFileToGoogleDrive() throws IOException {
            ...
            for (com.google.api.services.drive.model.File file : fileList.getFiles()) {
                ...
                if (file.getName().equals(KINOMETRIX_DIRECTORY_GOOGLEDRIVE_NAME)) {
            ...
            if (directoryFile != null) {
                ...
                directoryFile.setName(KINOMETRIX_DIRECTORY_GOOGLEDRIVE_NAME);
        ...
        protected void onCancelled() {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    Toast.makeText(GoogleDriveActivity.this, "The following error occurred:\n"
                            + mLastError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(GoogleDriveActivity.this, "Request cancelled.", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
